...
Section "MainSection" SEC01
  ...
  Push "$PROFILE\Lockheed Martin\Prepar3D v3\dll.xml" ; file to modify
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\P3D Discord Rich Presence\Uninstall.lnk" "$INSTDIR\uninst-FSXRichPresence.exe"
SectionEnd
