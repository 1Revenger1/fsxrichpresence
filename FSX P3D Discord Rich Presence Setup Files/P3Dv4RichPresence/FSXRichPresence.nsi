...
OutFile "P3DRichPresenceSetup_${PRODUCT_VERSION}.exe"
InstallDir "$PROGRAMFILES\Lockheed Martin\Prepar3D v4"
ShowInstDetails show
ShowUnInstDetails show

Section "MainSection" SEC01
  SetOutPath "$PROGRAMFILES\Lockheed Martin\Prepar3D v4"
  SetOverwrite ifnewer
  File "FSXRichPresence.dll"
  File "discord-rpc.dll"
  Push "$PROFILE\AppData\Roaming\Lockheed Martin\Prepar3D v4\dll.xml" ; file to modify
...
Section Uninstall
  ...
  Delete "$PROGRAMFILES\Lockheed Martin\Prepar3D v4\discord-rpc.dll"
  Delete "$PROGRAMFILES\Lockheed Martin\Prepar3D v4\FSXRichPresence.dll"

  Delete "$SMPROGRAMS\P3D Discord Rich Presence\Uninstall.lnk"

  RMDir "$SMPROGRAMS\P3D Discord Rich Presence"
  RMDir "$PROGRAMFILES\Lockheed Martin\Prepar3D v4"
